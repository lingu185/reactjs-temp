    ...
    return (
      <div className="sidebar__content">
        <ul className="sidebar__block">
          <SidebarLink title="Dashboard" icon="home" route="/dashboard/mainpage" onClick={this.hideSidebar} />
          {/* <SidebarLink
            title="Add School"
            icon="store"
            route="/dasboard/AddSchool"
            onClick={this.hideSidebar}
          /> */}
          <SidebarLink
            title="Add School"
            icon="store"
            route="/dashboard/AddSchool"
            onClick={this.hideSidebar}
          />
          <SidebarLink
            title="Add Teacher"
            icon="rocket"
            route="/dashboard/AddTeacher"
            onClick={this.hideSidebar}
          />
          <SidebarLink
            title="AddStudent"
          ...
          <SidebarLink
            ...
            route="/dashboard/CreateAssessment"
            onClick={this.hideSidebar}
          />
